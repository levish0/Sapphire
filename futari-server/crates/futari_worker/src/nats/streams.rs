...
pub const EMAIL_STREAM: &str = "futari_jobs_email";
/// JetStream stream name for index user jobs.
pub const INDEX_USER_STREAM: &str = "futari_jobs_index_user";
/// JetStream stream name for index post jobs.
pub const INDEX_POST_STREAM: &str = "futari_jobs_index_post";
/// JetStream stream name for reindex users jobs.
pub const REINDEX_USERS_STREAM: &str = "futari_jobs_reindex_users";

// Subjects (for publishing)
/// NATS subject used to publish email jobs.
pub const EMAIL_SUBJECT: &str = "futari.jobs.email";
/// NATS subject used to publish index user jobs.
pub const INDEX_USER_SUBJECT: &str = "futari.jobs.index.user";
/// NATS subject used to publish index post jobs.
pub const INDEX_POST_SUBJECT: &str = "futari.jobs.index.post";
/// NATS subject used to publish reindex users jobs.
pub const REINDEX_USERS_SUBJECT: &str = "futari.jobs.reindex.users";
